...
object WordCount {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // a)
    val rdd = sc.textFile("/Users/rafman/spark-2.3.1-bin-hadoop2.7/README.md")
    ...
    val df2 = spark
      .read
      .text("/Users/rafman/spark-2.3.1-bin-hadoop2.7/README.md") // read.text retourne un dataFrame avec une seule colonne, nommée "value"
    ...
    val df_wordCount = sc.textFile("/Users/rafman/spark-2.3.1-bin-hadoop2.7/README.md")
    ...
    val df_wordCount_light = sc.textFile("/Users/rafman/spark-2.3.1-bin-hadoop2.7/README.md")
      .flatMap { line: String => line.split(" ") }
      .map { word: String => (word, 1) }
      .reduceByKey { (i: Int, j: Int) => i + j }
      .toDF("word", "count")
    ...
    val df_wordCount_lighter = sc.textFile("/Users/rafman/spark-2.3.1-bin-hadoop2.7/README.md") // output RDD of lines : RDD[String]
    ...
    val df_wordCount_lightest = sc.textFile("/Users/rafman/spark-2.3.1-bin-hadoop2.7/README.md")
      .flatMap(_.split(" "))
      .map((_, 1))
      .reduceByKey(_ + _)
      .toDF("word", "count")
